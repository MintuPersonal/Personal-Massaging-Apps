# AI Agent Instructions for NECX Messaging App

## Project Architecture

This is a full-stack personal messaging application with the following structure:
...
- Dark mode UI following Figma design specs
...
- Frontend connects to backend using `http://localhost:3001/api/*`
...
### Frontend Patterns
- Dark theme with navy/blue backgrounds and green accents
- System fonts for typography
- Component structure: header, chat area, input section
- Single-user application design

## Key Files
- `backend/server.js` - Main Express server setup and middleware
- `frontend/src/App.jsx` - Root React component and routing
- `frontend/vite.config.js` - Development server configuration
- `frontend/src/App.css` - Dark theme styling

## Getting Started
Before making changes:
1. Check existing endpoints in `backend/server.js`
2. Review component hierarchy in `frontend/src`
3. Refer to Figma design for visual specifications
4. Ensure CORS and error handling remain consistent
